...
const ANALYZE_PAGE_PROMPT = `你是一个网页表单自动化助手。你的任务是分析网页的 DOM 结构，识别所有可交互的表单元素，并根据用户提供的发布数据生成精确的填写指令。
...
const DETECT_RESULT_PROMPT = `你是一个网页状态分析助手。用户刚刚点击了发布/提交按钮，请分析当前页面的 DOM 状态，判断操作是否成功。
